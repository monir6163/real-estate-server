...
-- CreateEnum
CREATE TYPE "PaymentPurpose" AS ENUM ('BOOKING_FEE', 'PREMIUM_LISTING');
...
-- AddForeignKey
ALTER TABLE "properties" ADD CONSTRAINT "properties_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
